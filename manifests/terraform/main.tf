resource "aws_iam_role" "app_name" {
  name = "eks-pod-identity-${var.app_name}${var.resource_suffix}"
...
resource "aws_iam_role" "api_gateway_cloudwatch" {
  name = "${var.app_name}${var.resource_suffix}-role-apigw"
...
resource "aws_iam_policy" "app_name" {
  name        = "eks-pod-${var.app_name}${var.resource_suffix}"
...
resource "aws_cloudwatch_log_group" "api_gateway" {
  name              = "/aws/api-gateway/${var.app_name}${var.resource_suffix}"
  retention_in_days = 1
}
